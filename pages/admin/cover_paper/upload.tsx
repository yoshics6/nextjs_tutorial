...
import { uploadCoverPaper } from "@/features/admin/cover_paper";
                  ...
                  >
                    <Box sx={{ width: "100%" }}>
                      ...
                      >
                        File Format:{" "}
                        <a
                          href={`/format/cover_paper/Upload_Cover_Paper.xlsx`}
                          style={{
                            marginLeft: "10px",
                            color: "blue",
                          }}
                ...
                fetch(imagevalue)
                  ...
                  .then(async (blob) => {
                    ...
                    const response: any = await axios.post(
                      `${urlupload}/cover_paper/upload`,
                      formData
                    );
                    if (response.data.status == "success") {
                      Swal.fire(
                        "Success!",
                        "Your cover paper has been uploaded.",
                        "success"
                      ).then(function () {
