...
import { uploadTextPaper } from "@/features/admin/text_paper";
                  ...
                  >
                    <Box sx={{ width: "100%" }}>
                      ...
                      >
                        File Format:{" "}
                        <a
                          href={`/format/text_paper/Upload_Text_Paper.xlsx`}
                          style={{
                            marginLeft: "10px",
                            color: "blue",
                          }}
                ...
                fetch(imagevalue)
                  ...
                  .then(async (blob) => {
                    ...
                    const response: any = await axios.post(
                      `${urlupload}/text_paper/upload`,
                      formData
                    );
                    if (response.data.status == "success") {
                      Swal.fire(
                        "Success!",
                        "Your text paper has been uploaded.",
                        "success"
                      ).then(function () {
