  ...
  const DeleteAll = (id: any) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Deleted!", "Your data has been deleted.", "success").then(
          function () {
            dispatch(deleteNews(id)).then((result: any) => {
      ...
      <Box sx={{ width: "100%", mt: 3 }}>
        <Paper sx={{ width: "100%", mb: 2 }}>
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            onClick={() => router.push("/admin/news/jp/add")}
          >
            Add News
          </Button>
          <TableContainer>
                            ...
                            <TableCell align="center">
                              ...
                              >
                                <IconButton
                                  ...
                                  onClick={() =>
                                    router.push(
                                      `/admin/news/jp/edit?id=${row.news_id}`
                                    )
                                  }
                                >
...
//   (store) => async () => {
//     const data: any = await store.dispatch(getNews());
//     console.log(data);
//     return {
//       props: {
